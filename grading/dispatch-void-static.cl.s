...
Main_init:
	...
	jr	$ra	
				...
				#Generating code for method complain in class Main
Main.complain:
	addiu	$sp $sp -4
	sw	$fp 0($sp)
	addiu	$sp $sp -4
	...
	addiu	$fp $sp 16
	move	$s0 $a0
				#Generating inner code for method complain with AR_size of 12
...
label0:
	...
	jalr	$t1
				...
				#Done Generating inner code for method complain with AR_size of 12
